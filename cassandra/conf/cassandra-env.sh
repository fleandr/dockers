...
calculate_heap_sizes()
{
    case "`uname`" in
        ...
        *)
            ...
            # cheap server
            system_memory_in_mb="250000"
            system_cpu_cores="250"
        ;;
    esac
    ...
    if [ "$half_system_memory_in_mb" -gt "25024" ]
    then
        half_system_memory_in_mb="25024"
    fi
    if [ "$quarter_system_memory_in_mb" -gt "16920" ]
    then
        quarter_system_memory_in_mb="16920"
    fi
